                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        foreach($obj_poitems as $item){
                                            $objMaxCost = $dbl->getMaxPurchaseCost($item->prodid);
                                            $objMinCost = $dbl->getMinPurchaseCost($item->prodid);
                                            ?>
                                        <tr>
                                            <td><?php echo $srno;?></td>
                                            <td><?php 
                                            ...
                                            <td><?php echo $item->totalvalue;?></td>
                                            <td><?php if($objMaxCost->max_cost != null){ echo $objMaxCost->max_cost; }else{ echo "-";}?></td>
                                            <td><?php if($objMinCost->min_cost != null){ echo $objMinCost->min_cost; }else{ echo "-";}?></td>
                                        </tr>
                                        <?php $srno = $srno + 1;
