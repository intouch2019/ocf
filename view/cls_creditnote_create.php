                             ...
                             <div class="box box-primary"><br>
                                 <div class="col-md-12">
                                     ...
                                     <div class="col-md-12">
                                         ...
                                         <input type="text" id="invoiceno" name="invoiceno" required class="form-control" placeholder="Please insert complete Invoice No e.g- CR270001/1819-27/1" value="<?php echo $this->getFieldValue("invoiceno"); ?>">
                                     </div>
                                 </div> 
                                 <div class="col-md-12">
                                    <br>                                     
                                    <div class="col-md-12">
                                         ...
                                         <input type="text" id="grndate" name="cndate" required class="form-control" placeholder="Credit Note Date" value="<?php echo $this->getFieldValue("cndate"); ?>">
                                    </div>
                                 </div>
                                 <div class="col-md-12">
                                     <br>
                                     <div class="col-md-12">
                                         ...
                                         <input type="number" id="discount" name="discount" required class="form-control" placeholder="Please insert number without % sign" value="<?php echo $this->getFieldValue("discount"); ?>">
                                     </div>
                                 </div> 
                                 <div class="col-md-12">
                                    <br>
