...
class cls_grn_create extends cls_renderer{
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <h2 class="title-bar">Create GRN</h2>
                        <div class="common-content-block">
                            <form  role="form" id="creategrn" name="creategrn" enctype="multipart/form-data" method="post" action="formpost/creategrn.php">
<!--                                <input type="hidden" name="poid" id="poid" value="<?php echo $this->poid;?>"/>-->
                                <input type = "hidden" name="form_id" id="form_id" value="creategrn">
                             <div class="box box-primary"><br>
                                ...
                                <div class="col-md-12">
                                 ...
                                 <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                         Select GRN Date : <br>
                                         <input type="text" id="grndate" name="grndate" class="form-control" placeholder="GRN Date" value="<?php echo $this->getFieldValue("grndate"); ?>">
                                    </div>
                                 </div>
                                 <div class="col-md-12">
                                    <br>                                     
