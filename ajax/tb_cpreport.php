...
$aColumns = array('createtime','dispname','cash','netbanking','debitcard','creditcard','cheque','total');
$sColumns = array('createtime','dispname');
...
$sQuery = " select rfc.dispname,date(p.createtime)as createtime from it_cr270001 c, it_payments_diary p , it_rfc_master rfc
        $sWhere  
        $sGroup
	$sOrder
	$sLimit
