...
$aColumns = array('voucher_no', 'prev_bal', 'amount', 'curr_bal' ,'description','reason','action');
$sColumns = array('voucher_no', 'description','reason');
...
$sQuery = "
	select SQL_CALC_FOUND_ROWS id, crid, amount, prev_bal, curr_bal, voucher_no, description, reason, by_user, ctime from it_imprest_details
	$sWhere 
	$sOrder
	$sLimit
";
