...
class showPDF {
    ...
    function addPageHeader() {
        ...
        return '<table align="center" width="100%" border="1" cellspacing="0" cellpadding="0">
                 ...
                 <p align="center"><b>Delivery Note</b></p>
    ...
    function addSupplierInfo($objpo, $grandToatl,$objchallan) {
        ...
        return '<table style="width:100%;" cellspacing="0" cellpadding="0">
                     <tr>
                     <td style="align=center;width:35%;height:10px;font-size:14px;" colspan ="4">Referance : '.$invoicerefno.' <b><br>Delivery Note No : ' . $invoiceno . '</b></td>
    ...
    function addCKTableHeader($totalLD) {
        ...
        $htmlt .= '<tr>
                  ...
                  <th style="align=left;font-size:12px;width:35%;">Product</th>
                  <th style="align=center;font-size:12px;width:6%;">Spec</th>
                  
                  <th style="align=center;font-size:12px;width:9%;">HSN Code</th>
                  <th style="align=center;font-size:12px;width:6%;">UOM</th>

                  <th style="align=center;font-size:12px;width:10%;">Actual Batch No</th>
                  <th style="align=center;font-size:12px;width:9%;">Actual Quantity (MT)</th>
...
';
        ...
        foreach ($objpolines as $line) {
            ...
            $htmlcktable .= '<tr>
                  ...
                  <td style="align=center;font-size:11px;width:10%;">Mild Steel</td>
                  <td style="align=left;font-size:11px;width:35%;">' . $products . '</td>
                  <td style="align=center;font-size:11px;width:6%;">'.$line->spec.'</td>
                  
                  <td style="align=center;font-size:11px;width:9%;">' . $line->hsncode . '</td>
                  <td style="align=center;font-size:11px;width:6%;">MT</td>

                  <td style="align=center;font-size:11px;width:10%;">' . $line->batchcode . '</td>
                  <td style="align=center;font-size:11px;width:9%;">' . $rounded_qty . '</td>
        ...
        $htmlcktable .= '<tr>
                  ...
                  <td style="align=center;font-size:11px;width:35%;"></td>
                  ...
                  <td style="align=center;font-size:11px;width:10%;"></td>
                  <th style="align=center;font-size:11px;width:9%;">'.$roundtotalActualQty.'</th>
