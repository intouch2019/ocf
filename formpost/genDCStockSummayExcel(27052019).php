...
$objPHPExcel->getActiveSheet()->setCellValue('K1', 'Base Rate (Rs./MT)');
$objPHPExcel->getActiveSheet()->setCellValue('L1', 'Total Rate (Rs./MT)');
$objPHPExcel->getActiveSheet()->setCellValue('M1', 'Base Value (Rs.)');
$objPHPExcel->getActiveSheet()->setCellValue('N1', 'Total Value (Rs.)');
$objPHPExcel->getActiveSheet()->setCellValue('O1', 'Stock Date');
...
if($date){
    ...
    foreach ($result as $obj) {
        ...
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(11, $rowCount, $obj->totalrate);        
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(12, $rowCount, $obj->bvalue);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(13, $rowCount, $obj->value);
        $stockDate = "";
        ...
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(14, $rowCount, $stockDate);
