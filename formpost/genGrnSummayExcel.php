...
$objPHPExcel->getActiveSheet()->setCellValue('M1', 'PO Length');
$objPHPExcel->getActiveSheet()->setCellValue('N1', 'GRN Length');
$objPHPExcel->getActiveSheet()->setCellValue('O1', 'Base Rate (Rs./MT)');
$objPHPExcel->getActiveSheet()->setCellValue('P1', 'Total Rate (Rs./MT)');
$objPHPExcel->getActiveSheet()->setCellValue('Q1', 'CGST');
$objPHPExcel->getActiveSheet()->setCellValue('R1', 'SGST');
$objPHPExcel->getActiveSheet()->setCellValue('S1', 'Base Value (Rs.)');
$objPHPExcel->getActiveSheet()->setCellValue('T1', 'Total Value (Rs.)');
$objPHPExcel->getActiveSheet()->setCellValue('U1', 'Createtime');
...
$result = $dbl->getGrnStockSummery($dcid);
    ...
    $FirstQty = round($obj->qty, 4, PHP_ROUND_HALF_UP);
    $qty = sprintf("%.4f", $FirstQty);
    
    $FirstQty1 = round($obj->base_rate, 2, PHP_ROUND_HALF_UP);
    $base_rate = sprintf("%.4f", $FirstQty1);
    
    $FirstQty2 = round($obj->total_rate, 2, PHP_ROUND_HALF_UP);
    $total_rate = sprintf("%.4f", $FirstQty2);
    
    $base_val = $qty * $base_rate;
    $total_val = $qty * $total_rate; 
        ...
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(12, $rowCount, $obj->polength);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(13, $rowCount, $obj->length);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(14, $rowCount, $obj->base_rate);  /////
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(15, $rowCount, $obj->total_rate);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(16, $rowCount, $obj->cgstval);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(17, $rowCount, $obj->sgstval);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(18, $rowCount, $base_val); /////////////
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(19, $rowCount, $total_val);//grndate
        //$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(15, $rowCount, $obj->createtime);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(20, $rowCount, $obj->grndate);  
