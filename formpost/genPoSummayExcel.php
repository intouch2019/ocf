...
$objPHPExcel->getActiveSheet()->setCellValue('L1', 'Base Rate (Rs./Kg)');
$objPHPExcel->getActiveSheet()->setCellValue('M1', 'LC Rate (Rs./Kg)');
$objPHPExcel->getActiveSheet()->setCellValue('N1', 'CGST');
$objPHPExcel->getActiveSheet()->setCellValue('O1', 'SGST');
$objPHPExcel->getActiveSheet()->setCellValue('P1', 'Rate (Rs.)');
$objPHPExcel->getActiveSheet()->setCellValue('Q1', 'Total Value(Rs.)');
$objPHPExcel->getActiveSheet()->setCellValue('R1', 'Createtime');
...
$result = $dbl->getPOStockSummery($dcid,$startDate,$endDate);
    ...
    foreach ($result as $obj) {
        ...
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(12, $rowCount, $obj->lcrate);
        ...
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(15, $rowCount, $obj->totalrate);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(16, $rowCount, $obj->totalvalue);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(17, $rowCount, $obj->createtime);
