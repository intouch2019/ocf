...
$objPHPExcel->getActiveSheet()->setCellValue('K1', 'Length');
$objPHPExcel->getActiveSheet()->setCellValue('L1', 'Base Rate (Rs./MT)');
$objPHPExcel->getActiveSheet()->setCellValue('M1', 'Total Rate (Rs./MT)');
$objPHPExcel->getActiveSheet()->setCellValue('N1', 'Base Value (Rs.)');
$objPHPExcel->getActiveSheet()->setCellValue('O1', 'Total Value (Rs.)');
$objPHPExcel->getActiveSheet()->setCellValue('P1', 'Stock Date');
...
if($date){
    ...
    $result = $dbl->getDCStockSummeryByCloseDate($dcid,$closeDate);
} else {
...
//return;
    ...
    foreach ($result as $obj) {
        ...
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(10, $rowCount, $obj->length);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(11, $rowCount, $obj->rate);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(12, $rowCount, $obj->totalrate);        
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(13, $rowCount, $obj->bvalue);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(14, $rowCount, $obj->value);
        $stockDate = "";
        ...
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(15, $rowCount, $stockDate);
...
header('Content-Disposition: attachment;filename="DC Stock Report_'.$stockDate.'.xls"');
