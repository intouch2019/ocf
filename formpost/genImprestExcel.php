...
$objPHPExcel->getActiveSheet()->setCellValue('B1', 'Pre-Transaction Balance');
$objPHPExcel->getActiveSheet()->setCellValue('C1', 'Transaction Amount');
$objPHPExcel->getActiveSheet()->setCellValue('D1', 'Post Transaction Balance');
$objPHPExcel->getActiveSheet()->setCellValue('E1', 'Voucher No.');
$objPHPExcel->getActiveSheet()->setCellValue('F1', 'Transaction');
$objPHPExcel->getActiveSheet()->setCellValue('G1', 'Reason');
$objPHPExcel->getActiveSheet()->setCellValue('H1', 'By User');
$objPHPExcel->getActiveSheet()->setCellValue('I1', 'Createtime');
...
$result = $dbl->getImprestExcelReport($crid,$FromDate,$ToDate);
    ...
    foreach ($result as $obj) {
        ...
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(1, $rowCount, $obj->prev_bal);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(2, $rowCount, $amount);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(3, $rowCount, $obj->curr_bal); 
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4, $rowCount, $obj->voucher_no);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5, $rowCount, $obj->description);  
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(6, $rowCount, $reason);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(7, $rowCount, $obj->name);
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(8, $rowCount, $obj->ctime);
